 ...
 * generated in the study package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldFromResponse_QNAME = new QName("http://eltech.study.com/", "sayHelloWorldFromResponse");
    private final static QName _SayHelloWorldFrom_QNAME = new QName("http://eltech.study.com/", "sayHelloWorldFrom");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: study
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://eltech.study.com/", name = "sayHelloWorldFromResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://eltech.study.com/", name = "sayHelloWorldFrom")
