 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://eltech.study.com/", wsdlLocation = "http://localhost:9000/SoapServer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://eltech.study.com/", "ServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9000/SoapServer?wsdl");
    ...
    public Server getServerPort() {
        return super.getPort(new QName("http://eltech.study.com/", "ServerPort"), Server.class);
    }
    ...
    public Server getServerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://eltech.study.com/", "ServerPort"), Server.class, features);
    }
